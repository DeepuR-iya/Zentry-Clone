...
const Hero = () => {
  ...
  useGSAP(() => {
    gsap.set("#video-frame", {
      clipPath: "polygon(14% 0%, 75% 0%, 90% 90%, 5% 90%)",
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      <div
        id="video-frame"
        className="relative h-dvh z-10 w-screen overflow-x-hidden bg-blue-75"
      >
        <div>
          <div className="mask-clip-path rounded-md absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden">
            <div
          ...
          />
          <video
            src={getVidSrc(currentIndex === totalVideos ? 4 : currentIndex)}
            autoPlay
            loop
            muted
